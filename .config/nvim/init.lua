...
-- The terminal configurations use Symbols Nerd Font Mono as an icon fallback.
...
-- Toggle word wrap for the current window
...
-- Navigate and resize seamlessly across Neovim splits and tmux panes.  The
-- module falls back to ordinary Neovim behavior when running outside tmux.
require('custom.tmux').setup()
